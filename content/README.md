...
Set `NEXT_PUBLIC_SITE_URL` to the production URL during deployment so canonical metadata and social previews point to the public site. The intended production URL is `https://leo.potatodog.cc`.
